...
export class ComponentEditComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.dateSelected = fnSetRangeDate(RangeDateOperation.Last7Days);
  }
  ...
  changeDateRange($event: any) {
    ...
    this.getProductSubmajor(fnFormatDate(this.dateSelected.start!), fnFormatDate(this.dateSelected.end!));
  }
