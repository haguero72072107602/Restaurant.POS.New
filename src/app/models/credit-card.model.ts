...
import {CardTypes} from "@core/utils/card-payment-types.enum";
...
export class CardManualPayment implements ICardManualPayment {
  constructor(public amount: number, public transferType: PaymentStatus = PaymentStatus.SALE,
              public receiptNumber: any, public accountNumber: any,
              public authCode: any, public cardType: string | CardTypes) {
  }
}
